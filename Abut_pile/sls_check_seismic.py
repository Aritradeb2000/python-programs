...
c = 0.03
#G49
dist_CG_centre_circle = 36.2517
#G50
eff_area_seg = 3251.59
#G51
eff_momt_iner = 342807
#G52
trans_area_steel = 1800.6
#G53
eff_tot_area = 5052.19
#B55
e_prime = 23.3316
#B56
e_minus_e_prime = 310.6053
#B57
i_effe = 3812450
#D58
dist_NA_geff = 2.429
...
comp_to = 2.4282
#D61
comp_str_conc_1 = 10.3807
#F61
comp_str_conc_2 = 156.676
#B62
...
def word_print(document, output_path):
     ...
     DocxHelper.add_main_heading(document, "Case - VII (Normal Load +Longitudinal Seismic+Vertical Seismic UP + Buoyancy)")
     p=document.add_paragraph()
     DocxHelper.add_minor_heading(document, "Seismic Case")
     p=document.add_paragraph()
     ...
     p.add_run(f"Buoyancy\t\t\t\t={buoyancy}\n")
     p.add_run(f"Earth quake\t\t\t\t={earthquake}\n")
